...
///////// endpoint pagina /////////
exp.post('/registrar-usuario', async (req, res) =>{
    const username = req.body['username']
    const passw = req.body['passw']
    const correo = req.body['correo']
    const telefono = req.body['telefono']
    const enviarInfo = req.body['enviarInfo']
    let result = await registrarUsuario(username, passw, correo, telefono, enviarInfo)
})

exp.post('/iniciar-sesion-usuario', async (req, res) =>{
    const username = req.body['username']
    const passw = req.body['passw']
    let result = await iniciarSesionPag(username, passw)
})
